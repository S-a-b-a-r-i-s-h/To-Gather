...
export async function editUser(
    ...
    const { userId, name, username, email, image, bio, userLocation, portfolio, github, linkedin } =
      validationResult.params!;
    // const userId = validationResult?.session?.user?.id;
  
    console.log(userId, name, username, email, image, bio, userLocation, portfolio, github, linkedin);
